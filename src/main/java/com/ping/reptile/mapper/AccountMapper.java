...
public interface AccountMapper extends BaseMapper<AccountEntity> {
    default String getAccount() {
        AccountEntity entity = selectOne(Wrappers.<AccountEntity>lambdaQuery().eq(AccountEntity::getState, 1).last("limit 1"));
        if (entity != null) {
    ...
    default void updateState(String account,String state) {
