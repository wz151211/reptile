...
public class TestPkulaw {
    ...
    public void testList() {
        ...
        Node punishmentDate = Node.builder().type("daterange").order(5).showText("处罚日期").fieldName("PunishmentDate").combineAs(2).fieldItems(Lists.newArrayList(Item.builder()
                ...
                .start("2021.09.01")
                .end("2021.10.01")
                .values(Lists.newArrayList("2021.09.01", "2021.09.01"))
                .build())).build();
        ...
        Pkulaw pkulaw = Pkulaw.builder()
                ...
                .pageIndex(0)
                .pageSize(10)
                .fieldNodes(Lists.newArrayList(category))
        ...
        HttpResponse response = HttpRequest.post(url)
                .timeout(-1)
                //  .body("{\"orderbyExpression\":\"PunishmentDate Desc\",\"pageIndex\":0,\"pageSize\":10,\"fieldNodes\":[{\"type\":\"select\",\"order\":4,\"showText\":\"主题分类\",\"fieldName\":\"Category\",\"combineAs\":2,\"fieldItems\":[{\"value\":[\"003\"],\"keywordTagData\":[\"003\"],\"order\":0,\"combineAs\":2,\"items\":[{\"value\":\"003\",\"name\":\"环保\",\"text\":\"环保\",\"path\":\"003\"}],\"filterNodes\":[]}]}],\"clusterFilters\":{},\"groupBy\":{}}")
                //  .cookie(cookie1, cookie2, cookie3, cookie4, cookie5, cookie6, cookie7, cookie8, cookie9, cookie10)
                //  .cookie(cookies)
               // .body("{\"orderbyExpression\":\"PunishmentDate Desc\",\"pageIndex\":0,\"pageSize\":10,\"fieldNodes\":[{\"type\":\"select\",\"order\":4,\"showText\":\"主题分类\",\"fieldName\":\"Category\",\"combineAs\":2,\"fieldItems\":[{\"order\":0,\"combineAs\":2,\"items\":[{\"name\":\"环保\",\"value\":\"003\",\"text\":\"环保\",\"path\":\"003\"}],\"value\":[\"003\"],\"keywordTagData\":[\"003\"]}]}],\"clusterFilters\":{},\"groupBy\":{}}")
                .body(jsonStr)
    ...
    public void testDetail() throws IOException {
        ...
        HttpCookie cookie1 = new HttpCookie("Hm_lvt_8266968662c086f34b2a3e2ae9014bf8", "1662819029");
        cookie1.setDomain(".pkulaw.com");
        cookie1.setPath("/");
        cookie1.setHttpOnly(false);
        cookie1.setSecure(false);

        HttpCookie cookie2 = new HttpCookie("xCloseNew", "11");
        ...
        HttpCookie cookie4 = new HttpCookie("pkulaw_v6_sessionid", "sd1pieglfax21wzylkaoawhq");
        ...
        HttpCookie cookie10 = new HttpCookie("Hm_lpvt_8266968662c086f34b2a3e2ae9014bf8", "1662859978");
